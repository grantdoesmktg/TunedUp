...
export async function incrementUsage(email, toolType) {
  console.log('🔼 incrementUsage called with:', { email, toolType })

  if (!email) {
    console.log('❌ No email provided, skipping usage increment')
    return
  }
  ...
  try {
    ...
    console.log('📝 Updating field:', updateField, 'for email:', email)
    ...
    console.log('✅ Usage incremented successfully. New count:', result[updateField])
  } catch (error) {
