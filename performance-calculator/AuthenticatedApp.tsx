...
export default function AuthenticatedPerformanceCalculator() {
  return (
    <AuthenticatedWidget
      ...
      widgetName="Performance Calculator"
    >
      {({ user, hasUsage, onUseQuota, isAuthenticated }) => {
        if (!hasUsage) {
          const usage = getRemainingUsage(user, 'performance')
              ...
              <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-orange-700 text-sm mt-1">
                    You've used {usage.used}/{usage.limit} performance calculations this month on your {user.planCode} plan.
                  </p>
                </div>

                <p className="text-gray-600 mb-6">
                  Upgrade your plan to continue using the Performance Calculator
                </p>
