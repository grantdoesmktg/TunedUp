    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="bg-secondary/50 backdrop-blur-sm border border-divider rounded-xl shadow-lg p-8">
        <div className="text-center mb-8">
          <GearIcon className="w-12 h-12 mx-auto text-primary mb-2"/>
          <h1 className="text-3xl font-bold text-textPrimary">Performance Estimator</h1>
          <p className="text-textSecondary mt-2">Enter your car's details and modifications for a comprehensive performance estimate.</p>
        </div>
